...
<div class="container-fluid" style="margin-top: 20px">
    <form action="statisticalbookteacher" method="post">
        ...
        <a href="./danhsachmuonsach.xls" download="giaovienmuonsach.xls"><button type="button" class="btn btn-success">Kết xuất excel</button></a>
