...
public class NewActive extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewActive</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewActive at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            if (a != null) {
                ...
                switch (type) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        request.getRequestDispatcher("NewActive.jsp").include(request, response);
                        break;
                }
            } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Part img = request.getPart("activeImg");
        ...
        img.write(realPath + n + fileName);
        String activeImg = "./assets/covers/" + n + fileName;
        String name = request.getParameter("name");
        new Active(activeImg, name).add();
        response.sendRedirect("listactive");
    }
