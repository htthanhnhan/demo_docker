...
public class NewPlan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewPlan</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewPlan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            if (a != null) {
                ...
                switch (type) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        request.getRequestDispatcher("NewPlan.jsp").include(request, response);
                        break;
                }
            } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName != null && !fileName.trim().equals("")) {
            ...
            new Plan(title, description, planImg).add();
        } else {
            new Plan(title, description, null).add();
        }
