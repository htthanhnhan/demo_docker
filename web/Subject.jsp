...
<section class="library">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <form action="subject" method="post" style="display: flex; margin-top: 7%">
                    <input name="v" class="input form-control" style="height: 46px" value="${v}" autocomplete="off" placeholder="Tìm kiếm tên sách trong môn học...">
                ...
                <div class="library__categories">
                    <div class="library__categories__all">
                        ...
                        <a href="subject"><span>Tất cả môn học</span></a>
                    </div>
                    <ul>
                        <c:forEach items="${listSubject}" var="s">
                            <li><a href="subject?id=${s.subjectID}" class="${tag == s.subjectID ? "active" : ""}">${s.subjectName}</a></li>                                              
                            </c:forEach>
                    </ul>
                </div>
            </div>
