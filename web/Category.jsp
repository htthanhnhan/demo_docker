...
<section class="library">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <form action="category" method="post" style="display: flex; margin-top: 7%">
                    <input name="v" class="input form-control" style="height: 46px" value="${v}" autocomplete="off" placeholder="Tìm kiếm tên sách trong thể loại...">
                ...
                <div class="library__categories">
                    <div class="library__categories__all">
                        ...
                        <a href="category"><span>Tất cả sách</span></a>
                    </div>
                    <ul>
                        <c:forEach items="${listCategory}" var="c">
                            <li><a href="category?id=${c.categoryID}" class="${tag == c.categoryID ? "active" : ""}">${c.categoryName}</a></li>                                              
                            </c:forEach>
                    </ul>
                </div>
            </div>
